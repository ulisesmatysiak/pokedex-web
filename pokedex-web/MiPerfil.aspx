...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <div class="mb-3">
                ...
                <asp:TextBox runat="server" CssClass="form-control" ID="txtApellido" ClientIDMode="Static" MaxLength="8" />
    ...
    <div class="row">
        <div class="col-md-4">
            <asp:Button Text="Guardar" CssClass="btn btn-primary" ID="btnGuardar" runat="server" OnClick="btnGuardar_Click" OnClientClick="return validar()" />
            <a href="/">Regresar</a>
        </div>
    </div>
